...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('patient_financing', {
    pf_id: {
      autoIncrement: true,
    ...
    ar_ez_disc_save_share_per_recurring: {
      type: DataTypes.FLOAT,
      allowNull: false,
      defaultValue: 0,
      comment: "deneftis share from amount saved from discount to customer per recurring amount"
    },
    ...
    contract_share_type: {
      type: DataTypes.INTEGER,
      allowNull: true,
      comment: "0 -> no share, 1 -> Old share, 2 -> Fixed share, 3-> both share"
    },
    qr_code: {
      type: DataTypes.TEXT,
      allowNull: true
    ...
    by_qrcode_scan: {
      ...
      allowNull: false,
      defaultValue: 0,
      comment: "0: Default, 1: Contract made by scan QRcode and pay method"
    },
    ...
    edit_contract_values: {
      type: DataTypes.JSON,
      allowNull: true,
      comment: "contract values after edit contract for deferred continue setting"
    },
    plan_type: {
      type: DataTypes.INTEGER,
      allowNull: false,
      defaultValue: 2,
      comment: "Cool Credit 1-Week 2-month 3-biweek"
    },
    is_recuvery: {
      type: DataTypes.INTEGER,
      allowNull: false,
    ...
    indexes: [
      ...
      {
        name: "patient_financing_idx_contract_id",
        using: "BTREE",
        fields: [
          { name: "contract_id" },
        ]

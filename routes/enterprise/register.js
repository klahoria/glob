...
const { DoctorRegisterController, CheckDoctorMobileController, sendRegistrationOTP, RegisterBusinessV2 } = require("../../controllers/enterprise/register");
...
router.get('/register_business_v2', RegisterBusinessV2);
